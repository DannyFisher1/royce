    ...
    return (
        ...
        >
                    ...
                    <div className="flex items-center gap-4 lg:gap-6 flex-shrink-0">
                        {providerSummary.logo && (
                            <Image
                                ...
                                height={80}
                                className="rounded-lg border bg-card p-1 shadow-sm" // Added subtle styling
                            />
                        )}
            ...
            <motion.section variants={itemVariants} className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mb-12 lg:mb-16">
                ...
                <div className="md:col-span-2 bg-card border rounded-xl p-6 shadow-sm flex flex-col sm:flex-row items-start gap-6">
            ...
            <motion.footer variants={itemVariants} className="mt-16 pt-8 border-t text-center">
